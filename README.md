...
* Set `pretrain: true` if you want to train the representation learning model from scratch, or `pretrain: false` if you would like the load the existing encoder's weights and only validate it.
* Select `seed`.
