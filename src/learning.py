...
def learn(cfg: DictConfig, encoder_name: str) -> None:
    ...
    datamodule: PtlsDataModule = instantiate(
        cfg["datamodule"], train_data=train_data, valid_data=val_data, test_data=test_data
    )
    ...
    if not trainer.fast_dev_run:
        torch.save(module.encoder.state_dict(), saved_models_path / f"{encoder_name}.pth")
