...
class CustomSeqToTarget(SequenceToTarget):
    def __init__(
        ...
        **kwargs
        ...
        if "is_reduce_sequence" in encoder.keys():
            encoder["is_reduce_sequence"] = True
        super().__init__(
        ...
        self.head = Head(
            encoder.hidden_size, objective="classification", num_classes=num_classes
        )
    ...
    def configure_optimizers(self):
        ...
        return {"optimizer" : optimizer, "scheduler": scheduler, "monitor" : self.metric_name}
